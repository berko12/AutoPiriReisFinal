...
$sql = "SELECT * from firmalar where id=$a";
            ...
            <div class="content-body">
                ...
                <div class="row">
                       ...
                       <div class="col-12 col-md-12 col-xl-4 col-right">
                            ...
                            <span>Şehir :</span> <b><?php echo $result->a4; ?></b> <br><br> 
...
$sayi=0;
$sql = "SELECT * from  isler    WHERE a8='$a'            ";
$query = $dbh -> prepare($sql);
$query->execute();
...
$sayi2=0;
$sql = "SELECT * from  isler    WHERE a8='$a'  and a10='Bitti'           ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
   ...
   <?php $cnt=$cnt+1; }} ?> 
               ...
               <div class="col-12 col-md-12 col-xl-4 col-right">
                  ...
                  <div class="card mb-12">
                      ...
                      <button type="submit" name="musterisil" class="btn btn-primary mb-0">Müşteriyi Sil</button>
</form>
                      </div>
                  </div>
