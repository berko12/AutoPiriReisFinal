                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="kakbir.php" method="post" novalidate>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <input type="text" name="a1" class="form-control" placeholder="Ad Soyad" required data-validation-required-message="Boş Bırakılamaz">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <input type="text" name="a4" class="form-control" placeholder="Ünvan" required data-validation-required-message="Boş Bırakılamaz">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <button type="submit" name="calisanekle" class="btn btn-primary">Ekle</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
